...
class EcsConfig(BaseModel):
    ...
    project_name: str = "atomic-sre"
    cluster_name: str = "atomic-sre"
    task_family: str = "atomic-sre"
    task_cpu: int = 512
    task_memory: int = 1024
    task_cpu_architecture: str = "X86_64"
    image_tag: str = "latest"
    ecr_repo_atomic_sre: str = "atomic-sre"
    ecr_repo_slack_mcp: str = "atomic-sre-slack-mcp"
    secret_anthropic_name: str = "atomic-sre/anthropic_api_key"
    secret_slack_bot_name: str = "atomic-sre/slack_bot_token"
    secret_github_token_name: str = "atomic-sre/github_token"
    log_group_name: str = "/ecs/atomic-sre"
...
class DeploymentState(BaseModel):
    ...
    ecr_atomic_sre_uri: str | None = None
