...
from atomic_sre.cli.configuration.options import (
    ...
    if choices:
        ...
        if selected_model == "custom":
            selected_model = _prompt_text(
                "Model ID (e.g. gpt-5.5, claude-sonnet-4-6, etc.):",
                current_model,
                force_reconfigure,
            )
