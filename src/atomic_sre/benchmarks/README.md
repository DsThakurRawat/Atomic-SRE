...
- [atomic-sre-eval](https://github.com/DsThakurRawat/Atomic-SRE-eval)
...
- `src/atomic_sre/benchmarks/routing/README.md`
- `src/atomic_sre/benchmarks/diagnostics/README.md`
