...
from atomic_sre.infrastructure.aws import check_deployment, create_session
...
from atomic_sre.interfaces.handlers.remote.aws.ecs.steps import ecs_config_from_cli
...
def deployment_resource_targets(config: CliConfig) -> dict[str, str]:
    ...
    ecr_targets = [config.deployment.ecr_atomic_sre_uri or config.ecs.ecr_repo_atomic_sre]
