...
from atomic_sre.engine.prompts import SYSTEM_PROMPT, build_diagnosis_prompt
from atomic_sre.engine.settings import AgentSettings, get_settings
from atomic_sre.engine.tools import create_cloudwatch_toolset
...
def _require_key(key: str | None, env_var: str, provider: str) -> SecretStr:
    ...
    Returns:
        The validated API key as SecretStr.
    """
