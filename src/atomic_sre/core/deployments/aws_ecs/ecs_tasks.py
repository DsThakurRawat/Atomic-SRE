...
from atomic_sre.core.deployments.aws_ecs.models import EcsDeploymentConfig

SRE_AGENT_CONTAINER_NAME = "atomic-sre"
...
def register_task_definition(
    ...
    if not config.ecr_atomic_sre_uri:
        raise RuntimeError("ECR repository for atomic-sre must be created first.")
    if (
    ...
    container_definitions = [
        {
            ...
            "image": f"{config.ecr_atomic_sre_uri}:{config.image_tag}",
            "essential": True,
            "environment": [
            ...
            "logConfiguration": {
                ...
                "options": {
                    ...
                    "awslogs-stream-prefix": "atomic-sre",
                },
            },
        },
        {
