...
from agentic_sre.core.deployments.aws_ecs.models import EcsDeploymentConfig

SRE_AGENT_CONTAINER_NAME = "agentic-sre"
...
def register_task_definition(
    ...
    if not config.ecr_agentic_sre_uri:
        raise RuntimeError("ECR repository for agentic-sre must be created first.")
    if (
    ...
    container_definitions = [
        {
            ...
            "image": f"{config.ecr_agentic_sre_uri}:{config.image_tag}",
            "essential": True,
            "environment": [
            ...
            "logConfiguration": {
                ...
                "options": {
                    ...
                    "awslogs-stream-prefix": "agentic-sre",
                },
            },
        },
        {
