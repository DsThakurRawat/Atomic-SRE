...
from agentic_sre.cli.mode.remote.aws.ecs.steps import ecs_config_from_cli
from agentic_sre.cli.presentation.console import console
from agentic_sre.core.deployments.aws_ecs import check_deployment, create_session
...
def deployment_resource_targets(config: CliConfig) -> dict[str, str]:
    ...
    ecr_targets = [config.deployment.ecr_agentic_sre_uri or config.ecs.ecr_repo_agentic_sre]
