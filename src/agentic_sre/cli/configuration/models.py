...
class EcsConfig(BaseModel):
    ...
    project_name: str = "agentic-sre"
    cluster_name: str = "agentic-sre"
    task_family: str = "agentic-sre"
    task_cpu: int = 512
    task_memory: int = 1024
    task_cpu_architecture: str = "X86_64"
    image_tag: str = "latest"
    ecr_repo_agentic_sre: str = "agentic-sre"
    ecr_repo_slack_mcp: str = "agentic-sre-slack-mcp"
    secret_anthropic_name: str = "agentic-sre/anthropic_api_key"
    secret_slack_bot_name: str = "agentic-sre/slack_bot_token"
    secret_github_token_name: str = "agentic-sre/github_token"
    log_group_name: str = "/ecs/agentic-sre"
...
class DeploymentState(BaseModel):
    ...
    ecr_agentic_sre_uri: str | None = None
